...
const CHANGE_INPUT = 'immerWaiting/CHANGE_INPUT'; // 인풋 값 변경
const CREATE = 'immerWaiting/CREATE'; // 명단에 이름 추가
const ENTER = 'immerWaiting/ENTER'; // 입장
const LEAVE = 'immerWaiting/LEAVE'; // 나감
