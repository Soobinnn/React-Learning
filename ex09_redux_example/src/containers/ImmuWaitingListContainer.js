...
import * as waitingActions from '../store/modules/immuWaiting';
import ImmuWaitingList from '../components/ImmuWaitingList';

class ImmuWaitingListContainer extends Component {
  // 인풋 변경 이벤트
  handleChange = e => {
